...
public class ImportResult {
	...
	private List<String> _parserWarnings = null;
	...
	public ImportResult (Element importResultElem)
	{
        ...
        for(int i = 0; i < importResChildren.getLength(); i++){
            ...
            if(tagName.equals("title")){
                ...
                NodeList warningElems = elem.getElementsByTagName("parserwarnings");
	...
	{
		Element rsp = (Element)importResultXmlDoc.getChildNodes().item(0);
		Element importResultListElem = rsp;
		
		ArrayList<ImportResult> results = new ArrayList<ImportResult>();
		NodeList importResultNodes = importResultListElem.getChildNodes();
