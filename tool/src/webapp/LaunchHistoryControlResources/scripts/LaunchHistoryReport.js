...
$(function() { 
  $("div.hide_show_div")
                    .click(function() {
                               ...
                               $(this).parent().toggleClass('shaded');
...
function mkFmtResponse(interaction) {
   ...
   var haveResult = interaction._resps[0].result !== undefined;
   var isCorrect = haveResult && (interaction._resps[0].result == 'correct');
   var result = {responseStr: (interaction.type == SCORM_CHOICE ? 'selected ' : 'responded ') +  '<span class="launch_int_response">' + mkFmtResp(interaction._resps[0].learner_response), 
                 ...
                 correctnessStr:(isNaN(interaction._resps[0].result) ? 
                                    ( haveResult ? 'is <span class="' + (isCorrect ? 'launch_int_response_correct' : 'launch_int_response_incorrect') + '">' + mkAbbr(interaction._resps[0].result) + '</span>' :
                                         'the course did not report as correct or incorrect' ) : 
